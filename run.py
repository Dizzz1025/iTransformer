...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, required=True, default='dpos', help='dataset type')
    ...
    parser.add_argument('--label_len', type=int, default=12, help='start token length') # no longer needed in inverted Transformers
